...
<https://github.com/dirkwa/sensesp-p4-cockpit-wasm>.
...
`src/lv_conf.h` in lockstep with the firmware's `lv_conf.h`.
...
it under any terms, including as part of sensesp-p4-cockpit-wasm releases. You
